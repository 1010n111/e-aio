 ...
 * 消费侧靠它做幂等键，位置固定让人一眼看到"这个事件可去重"，也让架构断言能机械检查。
 *
 ...
 */
public record ParamChangedEvent(String eventId, String changeType, String paramKey, String paramLevel, long ownerId) {
}
